...
st.set_page_config(layout="wide", page_title="Máy tính Phương Pháp Số")
st.title("Máy tính Phương pháp Tính với chức năng tùy chọn Bậc")
st.markdown("Một công cụ để giải và minh họa các phương pháp số cho các bài toán giá trị ban đầu $y' = f(t,y)$.")
